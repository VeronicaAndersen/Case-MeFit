...
var Form = (_temp = _class = function (_Component) {
   ...
   */
		...
		value: function validate() {
			...
			for (var _iterator7 = Object.keys(fields), _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
				...
				if (fields[_field]) {
					this._set(_field, values[_field], { changed: false });
				}
			}
   ...
   */
	...
	this.set = function (field, value) {
		return _this6._set(field, value, {});
	};

	this._set = function (field, value, _ref17) {
		var changed = _ref17.changed;
...
function Children(_ref18) {
	var values = _ref18.values,
	    reset = _ref18.reset,
	    set = _ref18.set,
	    clear = _ref18.clear,
	    scroll = _ref18.scroll,
	    focus = _ref18.focus,
	    watch = _ref18.watch,
	    submitting = _ref18.submitting,
...
function generateInitialFormState() {
	...
	var _ref19 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
	    _ref19$submitting = _ref19.submitting,
	    submitting = _ref19$submitting === undefined ? false : _ref19$submitting;
